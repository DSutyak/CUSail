...
// Polar plot  which gives expected speed of boat at a given heading with respect to the wind. 
...
void setWaypoints(void) {
  ...
  wayPoints[0] = outsideDuffield;
  wayPoints[1] =  engQuadRight;
  wayPoints[2] = outsideThurston;
  wayPoints[3] = engQuadX;;
  ...
  Serial1.println("\nThird coordinate: ");
  Serial1.print("latitude: "); Serial.println(wayPoints[2].longitude,6);
  Serial1.print("longitude: "); Serial.println(wayPoints[2].latitude,6);
