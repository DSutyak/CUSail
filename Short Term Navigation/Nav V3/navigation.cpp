...
void setWaypoints(void) {
  ...
  coord_t p1 = {42.444544, -76.483399}, p2 = {42.444821, -76.483566}, p3 = {100,100}, 
          ...
          duffEntrance = {42.444299, -76.482556}; // being stored as 42.444298, -76.482559  <-- fixed 
...
//  engQuadStairs.latitude = 42.444287; engQuadStairs.longitude = -76.483222;
  ...
  // using Google Maps
  coord_t outsideDuff = {42.444254, -76.482660}, outsideThurston = {42.444228, -76.483666},
          engQuadX = {42.444591, -76.483498}, bottomStairs = {42.444240, -76.483258},
          stephMakeSaneComments = {42.4444792, -76.483244}; 
...
*/
  ...
  wayPoints[0] = outsideDuff; //duffEntrance; // engQuadStairs; // p0
  wayPoints[1] =  stephMakeSaneComments;
  wayPoints[2] = outsideThurston;
  wayPoints[3] = engQuadX; // p3;
  wayPoints[4] = bottomStairs;
...
float toMeters(float lat1, float lon1, float lat2, float lon2){
  ...
  //Serial.print("   Distance in meters: ");  Serial.println(d);        // <---- ADD back in for debugging 
  return d;
}
...
//coming from north=0, E=90, S=180, W=270
  ...
  //fboat }
  // nCalls+=1;
//  sensorData.longi= -76.482486;
//  sensorData.lati=42.444263;

  Serial.print("Current location: "); Serial.print(sensorData.lati,6); Serial.print(", ");  Serial.println(sensorData.longi,6);
  Serial.print("Next waypoint #"); Serial.print(wpNum); 
  Serial.print(": "); //Serial.print(":    Latitude: "); 
  Serial.print(wayPoints[wpNum].latitude,6); 
  Serial.print(", ");  //Serial.print("  Longitude: "); 
  Serial.println(wayPoints[wpNum].longitude,6);

  Serial1.print("Current location: "); Serial1.print(sensorData.lati,6); Serial1.print(", ");  Serial1.println(sensorData.longi,6);
  Serial1.print("Next waypoint #"); Serial1.print(wpNum); 
  Serial1.print(": "); //Serial1.print(":    Latitude: "); 
  Serial1.print(wayPoints[wpNum].latitude,6); 
  Serial1.print(", ");  //Serial1.print("  Longitude: "); 
...
//  Serial1.print("  Longitude: "); Serial1.println(wayPoints[wpNum].longitude,6);
  //Serial1.print("wpNum: "); Serial.println(wpNum);
